...
/**
 * 1800. Maximum Ascending Subarray Sum Easy Topics premium lock icon Companies
 * Hint Given an array of positive integers nums, return the maximum possible
 ...
 * ascending subarray with the maximum sum of 65. Example 2:
 * 
 * Input: nums = [10,20,30,40,50] Output: 150 Explanation: [10,20,30,40,50] is
 * the ascending subarray with the maximum sum of 150. Example 3:
 * 
...
public class MaximumAscendingSubarraySum_1800 {
	...
	public static int maxAscendingSumV2(int[] nums) {
	    int maxSum = nums[0];
